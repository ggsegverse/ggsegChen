# Quick instructions for AI coding agents working on ggsegChen
...
- `data/*.rda` -- Unified `ggseg_atlas` objects (2D only, no 3D data)
- `R/data.R` -- Roxygen2 documentation for each atlas
- `R/ggsegChen-package.R` -- Package-level docs, imports ggseg.formats
